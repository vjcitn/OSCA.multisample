...
```{r, echo=FALSE, eval=FALSE}. # not working in 3.15 are labels permuted?
...
stopifnot(igraph::are_adjacent(pseudo.out2$mst, "9", "7")). # not working in 3.15 .. are labels permuted?
